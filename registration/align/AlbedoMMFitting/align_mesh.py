...
meta_file_path = os.path.join(data_root, "transforms_select_flame.json")
meta_file_save_path = os.path.join(data_root, "transforms_aligned.json")

ms_mesh_path = os.path.join(data_root, "metashape_recon_scaled_flame.obj")
...
trimesh.Trimesh(
    ...
    visual=trimesh.visual.TextureVisuals(ms_uv)
).export(os.path.join(data_root, "metashape_recon_aligned.obj"))
